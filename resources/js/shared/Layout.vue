            ...
            <div class="min-h-screen flex flex-col" @click="hideDropdownMenus">
                <div class="md:flex">
                    <div
                        ...
                        <a class="mt-1" href="/">
                            <logo class="fill-current text-gray-100 hover:text-blue-400 inline-block" width="120" height="28"/>
                        </a>
                    ...
                    <div
                        ...
                        <dropdown class="mt-1" placement="bottom-end">
                            ...
                            <div slot="dropdown" class="mt-2 py-2 shadow-lg bg-white rounded text-sm">
                                <a class="block px-6 py-2 hover:bg-blue-500 hover:text-white">My Profile</a>
                                <a class="block px-6 py-2 hover:bg-blue-500 hover:text-white">Manage Users</a>
                                <a class="block px-6 py-2 hover:bg-blue-500 hover:text-white" method="post">Logout</a>
                            </div>
                        </dropdown>
                    </div>
                </div>
                <div class="flex flex-grow">
                    <div class="bg-blue-800 flex-no-shrink w-56 px-6 py-4 hidden md:block">
                        <main-menu/>
                    </div>
